/*! For license information please see main.8f729d92.js.LICENSE.txt */
!function() {
    var e = {
        694: function(e, t) {
            var n;
                        ...
                        kr.jsx)(zr, {
                            onClick: function() {
                                if (s) {
                                    ...
                                    e = t < .7 ? (.5 * Math.random() + 1.5).toFixed(2) : t < .9 ? (1 * Math.random() + 2).toFixed(2) : (2 * Math.random() + 3).toFixed(2),
                                    u(e),
                                    c(!1),
